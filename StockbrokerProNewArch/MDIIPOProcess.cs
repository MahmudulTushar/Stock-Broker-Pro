...
namespace StockbrokerProNewArch
{
	public partial class MDIIPOProcess: Form
	{
        ...
        private void SetPrevillize(string Previllize)
        {
            switch (Previllize)
            {
                ...
                case "Refund - Single Transfer Approval":
                    singleTransferApprovalToolStripMenuItem1.Visible = true;
                    break;

                case "Refund - Multi Transfer Approval":
                    multiTransferApprovalRefundToolStripMenuItem.Visible = true;
                    break;
                ...
                case "Apply Together - Money Deposit Approval":
                    moneyDepositApprovalApplyTogetherToolStripMenuItem.Visible = true;
                    break;
                ...
                case "Apply Together - Single Transfer Approval":
                    singleTransferApprovalApplyTogetherToolStripMenuItem.Visible = true;
                    break;

                case "Apply Together - Multi Transfer Approval":
                    multiTransferApprovalApplyTogetherToolStripMenuItem.Visible = true;
                    break;
                ...
                //Rashed Bhi Developed
                case "IPO NRB Draft And Application":
                    nRBToolStripMenuItem.Visible = true;
                    break;

                case "IPO NRB Draft And Application Approval":
                    nRBDraftAndAppApprovalApplyTogetherToolStripMenuItem.Visible = true;
                    break;

                case "IPO Parent Account Transfer Back Approval":
                    parentIpoAccApprovalToolStripMenuItem.Visible = true;
                    break;
                case "IPO Unblocked And Transfer Letter":
                    iPOUnblockedAndTransferLetterToolStripMenuItem.Visible = true;
                    break;

                case "IPO Forwarding Letter After Result":
                    iPOForwardingLetterAfterResultToolStripMenuItem.Visible = true;
                    break;
                case "IPO Approval Data Delete":
                    iPOApprovalDataDeleteToolStripMenuItem.Visible = true;
                    break;

                case "IPO NRB Draft Deposit And Application":
                    draftDepositAndApplicationToolStripMenuItem.Visible = true;
                    break;

                case "IPO NRB Draft Withdraw And Payto Issuer":
                    draftWithdrawToolStripMenuItem.Visible = true;
                    break;

                case "IPO NRB Draft Refund":
                    nRBDraftApprovalRefundToolStripMenuItem.Visible = true;
                    break;

                case"IPO Auto Application":
                    autoIPOApplicationToolStripMenuItem.Visible = true;
                    break;
        ...
        public void ResetPrevillize()
        {
            ...
            singleTransferApprovalToolStripMenuItem1.Visible = false;
            multiTransferApprovalRefundToolStripMenuItem.Visible = false;
            ...
            moneyDepositApprovalApplyTogetherToolStripMenuItem.Visible = false;
            ipoChequeApprovalDataToolStripMenuItem.Visible = false;
            singleTransferApprovalApplyTogetherToolStripMenuItem.Visible = false;
            multiTransferApprovalApplyTogetherToolStripMenuItem.Visible = false;
            ...
            //Rashed Vi Updated
            nRBToolStripMenuItem.Visible = false;
            nRBDraftAndAppApprovalApplyTogetherToolStripMenuItem.Visible = false;
            parentIpoAccApprovalToolStripMenuItem.Visible = false;
            iPOUnblockedAndTransferLetterToolStripMenuItem.Visible = false;
            iPOForwardingLetterAfterResultToolStripMenuItem.Visible = false;
            iPOApprovalDataDeleteToolStripMenuItem.Visible = false;
            draftWithdrawToolStripMenuItem.Visible = false;
            draftDepositAndApplicationToolStripMenuItem.Visible = false;
            nRBDraftApprovalRefundToolStripMenuItem.Visible = false;
            autoIPOApplicationToolStripMenuItem.Visible = false;
        }

        private void refunParentAccountTransferToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPOParentAccountTransferBackApproval);
            frm.Show();
        }

        private void iPOApprovalDataDeleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApprovalDelete del = new frm_IPOApprovalDelete();
            del.StartPosition = FormStartPosition.CenterScreen;
            del.Show();
        }

        private void iPOForwardingLetterAfterResultToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmIPOFordardingResultAfterResult frm = new frmIPOFordardingResultAfterResult();
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void iPOUnblockedAndTransferLetterToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmIPOUnblockAndTransferLetter frm = new frmIPOUnblockAndTransferLetter();
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void nRBToolStripMenuItem_Click(object sender, EventArgs e)
        {
            
        }

        private void nRBDraftAndApplicationApprovalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPONRBMoneyDepositAndApplication);
            frm.Show();
        }

        private void sMSLogToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmSMSSendReceiveShow frm = new frmSMSSendReceiveShow();
            frm.Show();
        }

        private void singleTransferApprovalToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPOSingleTransferBackApproval);
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        ...
        private void multiTransferApprovalRefundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPOMultiTransferBackApproval);
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        ...
        private void parentIpoAccApprovalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPOParentAccountTransferBackApproval);
            frm.Show();
        }

        private void multiTransferApprovalApplyTogetherToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPODepositMultiTransfer_ApplyTogther);
            frm.Show();
        }

        private void moneyDepositApprovalApplyTogetherToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPOMoneyDeposit_ApplyTogther);
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.ShowDialog(this);
        ...
        private void singleTransferApprovalApplyTogetherToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPODepositSingleTransfer_ApplyTogther);
            frm.Show();
        }

        private void nRBDraftAndAppApprovalApplyTogetherToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPONRBMoneyDepositAndApplication);
            frm.Show();
        }

        private void withdrawApToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPOWithdrawApproval_Refund);
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void iPOBlockLetterToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmIPORequestToBlockIPOAmount frm = new frmIPORequestToBlockIPOAmount();
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void ipoSubmissionReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmIPOSubmissionOfIPOcollectionFile_Hardcopy_And_Softcopy frm = new frmIPOSubmissionOfIPOcollectionFile_Hardcopy_And_Softcopy();
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void draftWithdrawToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPONRB_Application frm = new frm_IPONRB_Application(Indication_Forms_Title.IPONRBMoneyWithDrawAndApplication);
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void draftDepositAndApplicationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPONRB_Application frm = new frm_IPONRB_Application(Indication_Forms_Title.IPONRBMoneyDepositAndApplication);
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void nRBDraftApprovalRefundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //Indication_Forms_Title.IPOMoneyRefund_ForNrb
            frm_IPOApproval frm = new frm_IPOApproval(Indication_Forms_Title.IPOMoneyRefund_ForNrb);
            frm.Show();
        }

        private void autoIPOApplicationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_IPOAutoApplicaiton frm = new frm_IPOAutoApplicaiton();
            frm.StartPosition=FormStartPosition.CenterScreen;
            frm.Show();
        }

        private void eligibleClientToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //frm_IPOAutoApplicaiton autoIPO = new frm_IPOAutoApplicaiton(Indication_Forms_Title.EligibleCustomer_For_AutoApplication);
            //autoIPO.StartPosition = FormStartPosition.CenterScreen;
            //autoIPO.Show();
        }

        private void ineligibleClientToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //frm_IPOAutoApplicaiton autoIPO = new frm_IPOAutoApplicaiton(Indication_Forms_Title.InEligibleCustomer_For_AutoApplication);
            //autoIPO.StartPosition = FormStartPosition.CenterScreen;
            //autoIPO.Show();
        }

        private void allRegisterCodeForAutoApplicationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //frm_IPOAutoApplicaiton auto = new frm_IPOAutoApplicaiton(Indication_Forms_Title.AllRegisterCode_ForAutoApplication);
            //auto.StartPosition = FormStartPosition.CenterScreen;
            //auto.Show();
        }

        private void autoIPOApplicationToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            frm_IPOAutoApplicaiton auto = new frm_IPOAutoApplicaiton();
            auto.StartPosition = FormStartPosition.CenterScreen;
            auto.Show();
        }
