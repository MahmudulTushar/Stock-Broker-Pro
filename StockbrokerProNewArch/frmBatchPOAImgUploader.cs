...
namespace NewArch
{
    public partial class frmBatchPOAImgUploader : Form
    {
        ...
        private void ShowImageNumber(int imgNumber)
        {
            ...
            {
                MessageBox.Show("No Power of Atony Photo found.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void SaveImage()
        {
            ...
            for (int i = 0; i < imgCount; ++i)
            {
                ...
                if (pgbUpload.Value == imgCount)
                {
                    ...
                    _nDuplicatedID = 0;
                    _nImageSaveNumber = 0;
                    MessageBox.Show("Photo Sucessfully Upload Completed", "Photo Upload",
        ...
        private void frmBatch1stGurdiamImgUploader_Load(object sender, EventArgs e)
        {
            SettingInitialValue();
        }

        private void dtgImUploadDirInfo_DoubleClick(object sender, EventArgs e)
        {
        ...
        private void frmBatch2ndGurdianImgUploader_Load(object sender, EventArgs e)
        {
            SettingInitialValue();
        }


        private void frmBatchPOAImgUploader_Load(object sender, EventArgs e)
        {
            SettingInitialValue();
        }
