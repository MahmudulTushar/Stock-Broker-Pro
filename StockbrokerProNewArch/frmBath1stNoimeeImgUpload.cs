...
namespace NewArch
{
    public partial class frmBath1stNoimeeImgUpload : Form
    {
        ...
        public frmBath1stNoimeeImgUpload()
        {
            InitializeComponent();
        }
        ...
        private void ShowImageNumber(int imgNumber)
        {
            ...
            {
                MessageBox.Show("No 1st Noimee Photo found.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void frmBath1stNoimeeImgUpload_Load(object sender, EventArgs e)
        {
            SettingInitialValue();
        }
