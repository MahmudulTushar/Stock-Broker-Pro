...
{
    public partial class ShareLimit : Form
    {
        public ShareLimit()
        {
            InitializeComponent();
        ...
        private void btnShareLimit_Click(object sender, EventArgs e)
        {
            try
            {
                ShareLimitBAL shareLimitBal = new ShareLimitBAL();
                DataTable datatable = shareLimitBal.GetShareLimitData();
