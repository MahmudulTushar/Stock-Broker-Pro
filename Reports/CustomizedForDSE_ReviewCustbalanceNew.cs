...
namespace Reports
{
    public partial class CustomizedForDSE_ReviewCustbalanceNew : Form
    {
        ...
        public CustomizedForDSE_ReviewCustbalanceNew()
        {
            InitializeComponent();
        }
        ...
        public void ShowReviewReport()
        {
           ...
           /* else if (_negetiveToday)
            ...
            else if (_negTillSpecificDate)
            {
                ...
                DataTable dtCustNegTodayBalance = new DataTable();
                dtCustNegTodayBalance = custReviewBalanceBal.CustomisedDSE_NewGetCustNegBalanceTillSpecificDate(_fromDate, isSorted);
                crCustBalance.SetDataSource(dtCustNegTodayBalance);
            ...
            else if (_posTillSpecificDate)
            {
                ...
                DataTable dtCustNegTodayBalance = new DataTable();
                dtCustNegTodayBalance = custReviewBalanceBal.CustomisedDSE_NewGetCustPosBalanceTillSpecificDate(_fromDate, isSorted);
                crCustBalance.SetDataSource(dtCustNegTodayBalance);
