    ...
    public partial class frmReportDetaisInformation : Form
    {
        ...
        private void GetEmployeeList()
        {
            try
            {
                ...
                lblTotalEmployee.Text = "Total Employee : " + dtEmployeeList.Rows.Count.ToString();
        ...
        private void GetEmployeeInfo(string emoployeeCode)
        {
            try
            {
                ...
                {
                    txtFinalEmployeeCode.Text = emoployeeCode;
        ...
        private void GetEmployeeDatailsInfo(string EmployeeCode)
        {
            try
            {
                ...
                dtList = objReportBal.GetEmployeePurposeList(EmployeeCode);
                objEmployee.Subreports[0].SetDataSource(dtList);
