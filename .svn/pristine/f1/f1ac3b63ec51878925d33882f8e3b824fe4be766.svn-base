...
namespace StockbrokerProNewArch.Classes
{
    public class EmailClient
    {
        ...
        {
            client = new SmtpClient("smtp.livemail.co.uk", 25);
            client.Credentials = new System.Net.NetworkCredential("info@ksclbd.com", "@KSCL123");
            
            //2nd Option
            //client = new SmtpClient("mail.etoetechnologies.com", 25);
            //client.Credentials = new System.Net.NetworkCredential("shahrior@etoetechnologies.com", "shahrior[123");
        }
        ...
        private void SetUp_From()
        {
            ...
            //2nd Option
            //from = new MailAddress("shahrior@etoetechnologies.com",
            //       "Shahrior Kamal",
            //    System.Text.Encoding.UTF8);
        }
        ...
        public void SetMessages_MoneyTrans()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                //MailAddress to = new MailAddress("rezaul0920@gmail.com");
