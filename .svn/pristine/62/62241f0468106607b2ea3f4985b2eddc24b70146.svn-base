...
namespace NewArch
{
    public partial class frmBatchImgUploader : Form
    {
        ...
        private void ShowImageNumber(int imgNumber)
        {
            ...
            else
            {
                ...
                MessageBox.Show("No 2nd Account Holder Photo found.", "", MessageBoxButtons.OK,
        ...
        private void dtgImUploadDirInfo_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No Error Log Exists.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
