...
{
    public partial class frmBatch1stGurdiamImgUploader : Form
    {
        ...
        public frmBatch1stGurdiamImgUploader()
        {
            InitializeComponent();
        }
        ...
        private void ShowImageNumber(int imgNumber)
        {
            ...
            {
                MessageBox.Show("No Gurdian-1 Photo found.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void CreateColumnDtg()
        {
            ...
            colConcept1.Resizable = System.Windows.Forms.DataGridViewTriState.False;
            colConcept1.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.NotSortable;
