...
namespace NewArch
{
    public partial class frmBatch2ndGurdianImgUploader : Form
    {
        ...
        public frmBatch2ndGurdianImgUploader()
        {
            InitializeComponent();
        }
        ...
        private void ShowImageNumber(int imgNumber)
        {
            ...
            {
                MessageBox.Show("No Gurdian-2 Photo found.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void CreateColumnDtg()
        {
            ...
            colConcept2.HeaderText = "Image Photo";
