...
namespace BusinessAccessLayer.BO
{
    public class AdditionalInformationBO
    {
        ...
        ///First Row Integer
        private long _BOCatagoryID;

        private long _CustomerGroupID;

        ///Second Row Integer

        private long _StatementCycleID;

        private long _CompanyCategoryID;
