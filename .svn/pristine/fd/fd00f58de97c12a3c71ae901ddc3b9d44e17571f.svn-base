             ...
             string Query = @"
                            ...
                            FROM (    
                                            ...
                                            *                            
                                            ,(  
			                                            CASE 
			                                            WHEN ISNULL(TransferCode,'')<>'' THEN TransferCode+'_'+Convert(varchar(10),IPOSessionID)+'_'+Media_Type
			                                            ELSE Cust_Code+'_'+Convert(varchar(10),IPOSessionID)+'_'+Media_Type 
                                            END  ) AS SelectionID
                                           ...
                                           UNION ALL
                                                    ...
                                                    *                            
                                                    ...
                                                    END  ) AS SelectionID
                                                    From SMS_Sync_Import_IPORequest 
                                                    Where ApplicationType='Free Transaction'
                                                    AND  Payment_Media='IPO' 
                                                    AND Media_Type ='" + Indication_IPOPaymentTransaction.ChannelType_SMS + @"'
                                                    And SMSReqID NOT IN (
                                                                     Select ChannelID  From SBP_IPO_Customer_Broker_MoneyTransaction 
                                                                                    Where Intended_IPOSession_ID ='' AND Deposit_Withdraw='Deposit'
                                                                                    AND ChannelID Is Not Null AND Channel='" + Indication_IPOPaymentTransaction.ChannelType_SMS + @"'                                          
                                                                    UNION ALL
                                                                    SELECT [SMSReqID]
                                                                    FROM [SBP_Database].[dbo].[SMS_Sync_Import_IPORequest_DeleteLog]Where Media_Type ='" + Indication_IPOPaymentTransaction.ChannelType_SMS + @"'
                                                    )
                                           ...
                                           Select 
                                                    *                            
                                                    ...
                                                    And SMSReqID NOT IN (
                                                                     Select ChannelID  From SBP_IPO_Customer_Broker_MoneyTransaction 
                                                                                    Where Intended_IPOSession_ID ='' AND Deposit_Withdraw='Deposit'
                                                                                    AND ChannelID Is Not Null AND Channel='" + Indication_IPOPaymentTransaction.ChannelType_Email + @"'                                          
                                                                    UNION ALL
                                                                    SELECT [SMSReqID]
                                          ...
                                          Select 
                                            ...
                                            *                            
                                            ,(  
			                                            CASE 
			                                                    WHEN ApplicationType='" + Indication_IPOPaymentTransaction.SmsRequestType_Apply_Together + @"' AND ISNULL(TransferCode,'')<>'' THEN TransferCode+'_'+Convert(varchar(10),IPOSessionID)+'_'+Media_Type
			                                                    WHEN ApplicationType='" + Indication_IPOPaymentTransaction.SmsRequestType_Apply_Together + @"' AND ISNULL(TransferCode,'')=''  THEN Cust_Code+'_'+Convert(varchar(10),IPOSessionID)+'_'+Media_Type 
                                                                WHEN ApplicationType='" + Indication_IPOPaymentTransaction.WebRequestType_Free_Transaction + @"' THEN Cust_Code+'_'+CONVERT(VARCHAR(10),SMSReqID)+'_'+Media_Type
                                                        END  
                                            ) AS SelectionID
                                            From SMS_Sync_Import_IPORequest 
                                           ...
                                           UNION ALL
                                            Select 
                                                    *                            
                                                    ...
                                                    And SMSReqID NOT IN (
                                                                     Select ChannelID  From SBP_IPO_Customer_Broker_MoneyTransaction 
                                                                                    Where Intended_IPOSession_ID ='' AND Deposit_Withdraw='Withdraw'
                                                                                    AND ChannelID Is Not Null AND Channel='" + Indication_IPOPaymentTransaction.ChannelType_SMS + @"'                                          
                                                                    UNION ALL
                                                                    SELECT [SMSReqID]
                                                                    FROM [SBP_Database].[dbo].[SMS_Sync_Import_IPORequest_DeleteLog]Where Media_Type ='" + Indication_IPOPaymentTransaction.ChannelType_SMS + @"'
