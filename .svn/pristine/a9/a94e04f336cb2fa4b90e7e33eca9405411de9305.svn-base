...
namespace NewArch
{
    public partial class frmBathchAuthorImgUpload : Form
    {
        ...
        public frmBathchAuthorImgUpload()
        {
            InitializeComponent();
        }
        ...
        private void ShowImageNumber(int imgNumber)
        {
            ...
            {
                MessageBox.Show("No Authorized Person Photo found.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void frmBathchAuthorImgUpload_Load(object sender, EventArgs e)
        {
            SettingInitialValue();
        }
